...
- 💡 **VDL Interior Light Toggles** - Gedimmt (30%) und Hell (100%)
- 🔄 **API-basierte Status-Synchronisation** - Icons synchronisieren sich mit Bus-Status
- 📊 **3-State Interior Lights** - Primary (Off), Secondary (Bright), Tertiary (Dimmed)
- 🚪 **VDL Door Events** - Event-Namen angepasst für VDL
...
- ✨ **Erste Universal-Version** - Solaris & Mercedes in einem Plugin
- ✅ Alle Features beider Busse vereint
- ✅ Separate Kategorie "BlackMautz TML Telemetry - ALL"
...
├── actions/               # Button-Icons & Inspectors
...
→ Get automatic email notifications when new updates are available! 📧
...
- 🚦 **Retarder Toggle** - Engine brake/retarder on/off (universal)
- 🚗 **Traction Control (ASR)** - Traction control toggle (universal)
- 🚦 **RBL Toggle** - Traffic signal priority system for green wave
...
- 💡 **VDL Interior Light Toggles** - Dimmed (30%) and Bright (100%)
- 🔄 **API-based Status Synchronization** - Icons synchronize with bus status
- 📊 **3-State Interior Lights** - Primary (Off), Secondary (Bright), Tertiary (Dimmed)
- 🚪 **VDL Door Events** - Event names adapted for VDL
...
### v2.0.0 - Universal Edition (2025-11-28)
- ✨ **First Universal Version** - Solaris & Mercedes in one plugin
- ✅ All features of both buses combined
